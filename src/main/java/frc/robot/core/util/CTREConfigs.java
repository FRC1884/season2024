  ...
  public CTREConfigs() {
    ...
    swerveAngleFXConfig =
        new TalonFXConfiguration()
            ...
            .withCurrentLimits(
                new CurrentLimitsConfigs().withSupplyCurrentLimit(angleSupplyLimit.currentLimit));
        ...
        new TalonFXConfiguration()
            ...
            .withOpenLoopRamps(
                new OpenLoopRampsConfigs()
                    .withVoltageOpenLoopRampPeriod(SwerveConstants.OPEN_LOOP_RAMP))
            .withClosedLoopRamps(
                new ClosedLoopRampsConfigs()
                    .withVoltageClosedLoopRampPeriod(SwerveConstants.CLOSED_LOOP_RAMP));
