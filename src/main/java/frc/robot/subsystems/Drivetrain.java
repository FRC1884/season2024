 ...
 * ({@link MAXSwerve} or {@link Swerve} for this season, which this class extends).
 * As of now, this includes basic driving and odometry, so you shouldn't try to reinvent the wheel.
 */
public class Drivetrain extends MAXSwerve {
    ...
    public Command followPathCommand(Supplier<PathPlannerPath> pathSupplier) {
        return new FollowPathHolonomic(
                ...
                () -> ChassisSpeeds.fromFieldRelativeSpeeds(KINEMATICS.toChassisSpeeds(), new Rotation2d(getHeading())), // ChassisSpeeds supplier. MUST BE ROBOT RELATIVE
