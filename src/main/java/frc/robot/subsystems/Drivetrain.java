 ...
 * <br>
 * This is the Drive subsystem for the 2024 season. Throughout the season, add
 * everything driving
 * here. <br>
 * <br>
 * Think:
 ...
 * ({@link MAXSwerve}
 * or {@link Swerve} for this season, which this class extends). As of now, this
 * includes basic
...
public class Drivetrain extends MAXSwerve {
   ...
   * Tweak constructor values (port configs) in
   * {@link frc.robot.RobotMap.DriveMap}
   *
   * @return the singleton of this class. Use this to reference the drivetrain
   *         between classes and
   *         Commands.
   */
   ...
   * <b>Do <i>not</i> attempt to create new instances of any subsystem using the
   * constructor.</b>
   *
   * @see #getInstance
   */
   ...
   * @param pathName a String representing the name of the path. These should be
   *                 automatically added
  ...
  /**
   * This method is called once per cycle – or "period", hence its name. On the
   * RoboRIO, this means
   * code inside is run once every ~10ms, or one hundredths of a second. Put
   * everything that should
   * be running throughout the entirety of the match in this method. <br>
   * <br>
   * <i>Usually,</i> the drivetrain needs to do nothing more than repeatedly
   * update odometry.
   */
  @Override
